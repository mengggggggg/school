    ...
    public class BackProductFPController : Controller
    {
        ...
        public ActionResult SelectforProduct()
        {
            ...
            try
            {
                ...
                sql = "select * from Products_Data where Store_ID = @Store_ID";
        ...
        public ActionResult chgdnProduct(int Pid)
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                TempData["upmsg"] = "成功下架！";
                return RedirectToAction("SelectforProduct");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public ActionResult UploadforProduct()
        {
            if (Session["Member_identity"] != null)
            {
                if (Session["Member_identity"].ToString() == "商家")
        ...
        public ActionResult UploadforProduct(HttpPostedFileBase File, Proshop inModel, string select)
        {
            if (Session["Member_identity"] != null)
            {
                if (Session["Member_identity"].ToString() == "商家")
            ...
            try
            {
                ...
                sql = @"Select Store_ID From Store_Data where Member_Account = @Member_Account";
                cmd = new SqlCommand();
                cmd.Connection = conn;
                cmd.CommandText = sql;
                cmd.CommandText = sql;
            ...
            return RedirectToAction("UploadforProduct");
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult uptForProduct(HttpPostedFileBase File, Proshop product, string select)
        {
            if (Session["Member_identity"] != null)
            {
                if (Session["Member_identity"].ToString() == "商家")
        ...
        public ActionResult uptForProduct(string Product_ID)
        {
            if (Session["Member_identity"] != null)
            {
                if (Session["Member_identity"].ToString() == "商家")
        ...
        public ActionResult delForProduct(int Product_ID)
        {
            if (Session["Member_identity"] != null)
            {
                if (Session["Member_identity"].ToString() == "商家")
            ...
            BackProductFPController productController = new BackProductFPController();
            productController.delForProductById(Product_ID);
            TempData["delp"] = "刪除成功";
            return RedirectToAction("SelectforProduct");
        }

        public void delForProductById(int Product_ID)
        {
